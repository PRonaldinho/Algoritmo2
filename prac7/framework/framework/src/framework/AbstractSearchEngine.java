...
import java.util.List; // necessary for the use of lists

public abstract class AbstractSearchEngine<S extends State,Problem extends AbstractSearchProblem<S>> {
   ...
   */
  public abstract List<S> getPath();
