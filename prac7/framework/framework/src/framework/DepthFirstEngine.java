...
public class DepthFirstEngine<S extends State, Problem extends AbstractSearchProblem<S>> extends AbstractSearchEngine<S,Problem> {
   ...
   */
  public DepthFirstEngine(Problem p) {
    super(p);
    visited = new LinkedList<S>();
    path = new LinkedList<S>();
  }
