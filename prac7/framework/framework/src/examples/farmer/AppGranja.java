...
public class AppGranja {
  ...
  /**
   * Main application of Granja example.
   */
  public static void main(String[] args) {

    ProblemaGranja p = new ProblemaGranja();
    DepthFirstEngine<EstadoGranja, ProblemaGranja> engine1 = 
          new DepthFirstEngine<EstadoGranja, ProblemaGranja>(p);
    boolean success = engine1.performSearch();
    System.out.println();
    System.out.println("*** Result using bounded depth-first search ***");
